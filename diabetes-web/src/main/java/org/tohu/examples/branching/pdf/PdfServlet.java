...
import com.viethealthcare.Recommendation;
...
public class PdfServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			document.open();
			Paragraph title = new Paragraph("diabetes Session Data");
	...
	/**
	 * Returns a collection of recommendation objects from the diabetes knowledge session
	 *	 *
