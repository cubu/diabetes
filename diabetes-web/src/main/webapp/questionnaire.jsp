...
<%
	...
	//helper.newKnowledgeSession("diabetes");
	
	//KnowledgeRuntimeLogger logger = KnowledgeRuntimeLoggerFactory.newFileLogger(helper.getKnowledgeSession(), "diabetes_logFile");
%>
