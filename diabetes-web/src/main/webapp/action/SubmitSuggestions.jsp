...
"java.util.*, 
com.viethealthcare.*,
com.viethealthcare.diabetes.web.*;"
%>
...
<link rel="stylesheet" type="text/css" media="screen" href="/diabetes-web/css/oldStyle.css" />
<script type="text/javascript" src="/diabetes-web/script/oldExtras.js"></script>

<title>diabetes :: SubmitSuggestion</title>
</head>
<body> 
<%
